...
\begin{figure}[H]
	\centering
    \includegraphics[width=0.8\textwidth]{graph_loop}
...
\end{figure}
	...
	Todas essas características fazem com que o OrientDB seja um SGBD bastante flexível e confiável para se utilizar em diversas aplicações. As operações utilizando grafos em específico, vem ganhando bastante visibilidade pois funciona muito bem em certos domínios de aplicação.
...
\begin{figure}[h]
	\centering
    \includegraphics[width=0.65\textwidth]{master-slave}
...
\begin{figure}[h]
	\centering
    \includegraphics[width=0.5\textwidth]{multi-master}
...
\begin{figure}[h]
	\centering
    \includegraphics[width=0.7\textwidth]{teleporter-inheritance-orientdb-schema}
...
\begin{figure}[H]
	\centering
    \includegraphics[width=0.6\textwidth]{class-clusters}
